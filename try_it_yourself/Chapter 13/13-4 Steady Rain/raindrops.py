...
class Raindrops:
    def __init__(self):
        ...
        self.raindrop_image = pygame.image.load("images/raindrop.bmp").convert_alpha()
        self.raindrop_image = pygame.transform.scale(self.raindrop_image, (66, 66))
    ...
    def check_raindrops_edges(self):
    ...
    def _add_new_row(self):
        ...
        while current_x < (self.settings.screen_width - 2 * raindrop_width):
            self._create_raindrop(current_x, raindrop_height)
            current_x += 2 * raindrop_width
